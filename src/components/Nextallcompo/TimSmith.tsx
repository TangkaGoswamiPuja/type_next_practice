...
const TimSmith = () => {
  return (
    <div>
       <div className=' my-12 max-w-7xl mx-auto w-[1440] h-[390]'>
          ...
          <div>
                      ...
                      <div className="px-[20] w-[748] h-[244]">
 ...
 <div className='flex flex-col gap-5 items-center justify-evenly mt-4 lg:flex-row '>
