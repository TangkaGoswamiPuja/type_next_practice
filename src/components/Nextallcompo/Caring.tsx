    ...
    <div> <div className='w-full my-12 max-w-7xl mx-auto flex flex-col gap-4 '  >
      ...
      <div className='text-center '>
        <h1 className="text-[#4D4D4D]
          lg: text-[36px] font-[600px]  leading-[44px]  ">
          Caring is the new marketing               </h1>
        <p className="text-[#717171] text-[16px] font-[400]  leading-[24px] mt-[2px]">
      ...
      <div className='flex flex-col gap-10 items-center justify-evenly mt-4 lg:flex-row '>
        ...
        <div className=" flex flex-col items-center text-center" >
          ...
          <div className='flex flex-col items-center justify-center bg-[#F5F7FA] p-[16px] gap-[16px] rounded-[8px] shadow-[#ABBED166] drop-shadow-lg mt-[-100px] '  >
            ...
            <div className='flex items-center justify-center w-[223px] h-[44px] p-[8px] gap-[8px]'>
